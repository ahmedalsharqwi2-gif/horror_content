...
=== تعديل مكان وحجم النص (مطابقة الصورة المرجعية بالملي) ===
اتقاسوا موقع النص في الصورة المرجعية بتحليل البكسلات فعليًا:
- إطار الفيديو الحقيقي في الصورة (من غير status bar وشريط اليوتيوب السفلي)
  امتد بين y=64 و y=1165 من أصل ارتفاع صورة 1280px → ارتفاع فعلي 1101px
- أول سطر في الكابشن بدأ عند نسبة 14.2% من أعلى إطار الفيديو
- على مقاس الفيديو الناتج عندنا (1080×1920) ده معناه إن المسافة من
  أعلى الفريم لبداية النص المفروض تبقى تقريبًا 270px (مش 160 زي القديم،
  وده اللي كان بيخلي النص شكله أعلى من الصورة المرجعية بمسافة واضحة)
- حجم الخط اتقاس بنفس الطريقة وطلع قريب جدًا من القديم، عدّلناه لـ 54
  بدل 56 عشان يطابق بالظبط
"""
...
# الشاشة لحد بداية النص — القيمة 270 مقاسة فعليًا من الصورة المرجعية
# (كانت 160 قبل كده وده كان بيخلي النص أعلى من المطلوب).
SUBTITLE_STYLE = (
    "FontName=Arial,FontSize=54,Bold=1,"
    "PrimaryColour=&H00FFFFFF,OutlineColour=&H00000000,"
    "BorderStyle=1,Outline=3,Shadow=1,"
    "Alignment=8,MarginL=60,MarginR=60,MarginV=270,"
...
def main():
    ...
    print("✅ النص: FontSize=54 Bold، سطران كحد أقصى، أعلى الشاشة (MarginV=270)، في المنتصف")
